...
Revision ID: e113fed9967b
Revises: 
Create Date: 2022-12-25 23:32:51.614490
...
def upgrade():
    ...
    op.create_table('customer_saved_product',
    sa.Column('product_id', sa.Integer(), nullable=False),
    sa.Column('customer_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customer.id'], name=op.f('fk_customer_saved_product_customer_id_customer')),
    sa.ForeignKeyConstraint(['product_id'], ['product.id'], name=op.f('fk_customer_saved_product_product_id_product')),
    sa.PrimaryKeyConstraint('product_id', 'customer_id', name=op.f('pk_customer_saved_product'))
    )
...
def downgrade():
    ...
    op.drop_table('order')
    op.drop_table('customer_saved_product')
